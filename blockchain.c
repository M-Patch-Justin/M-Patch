...
//Pproof of transaction function that searches for right proof. Exits if the node is beaten, or exit signal is sent
long proof_of_transaction(int* beaten, char* last_hash, char* trans_hash) {
